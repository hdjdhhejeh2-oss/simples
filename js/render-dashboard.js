...
function renderCandidatesList() {
    ...
    const courseFilterSelect = temp.querySelector('#courseFilterSelect');
    ...
    const statusFilterSelect = temp.querySelector('#statusFilterSelect');
...
function renderCandidateForm() {
    ...
    // Preencher cursos
    const courseSelect = temp.querySelector('#courseSelect');
    if (courseSelect) {
