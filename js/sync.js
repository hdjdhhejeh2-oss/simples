...
class DataSync {
    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        if (typeof appState !== 'undefined') {
          ...
          console.log('[Sync] ✅ AppState atualizado - Publicado:', appState.isPublished, 'Candidatos:', appState.candidates.length);
        }
  ...
  async syncToServer() {
    try {
      ...
      // Garantir que 'published' está sendo enviado
      if (typeof appState !== 'undefined') {
        localData.published = appState.isPublished;
      }
      
      console.log('[Sync] Enviando para servidor - Publicado:', localData.published, 'Candidatos:', localData.candidates.length);
